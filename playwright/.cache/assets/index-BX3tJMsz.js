const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Popover-cdf3Gqcv.js","assets/Button_ts-C-PV7mXT.js","assets/Popover-sS2-RU3u.css"])))=>i.map(i=>d[i]);
...
const _Users_josh_Documents_Svelte_OSP_SvARIA_src_lib_Button_ts_svelte = () => __vitePreload(() => import('./Button_ts-C-PV7mXT.js').then(n => n.b),true?[]:void 0).then((mod) => mod.default);
const _Users_josh_Documents_Svelte_OSP_SvARIA_tests__lib_Popover_svelte = () => __vitePreload(() => import('./Popover-cdf3Gqcv.js'),true?__vite__mapDeps([0,1,2]):void 0).then((mod) => mod.default);
__pwRegistry.initialize({ _Users_josh_Documents_Svelte_OSP_SvARIA_src_lib_Button_ts_svelte,
  _Users_josh_Documents_Svelte_OSP_SvARIA_tests__lib_Popover_svelte });

export { safe_not_equal as A, text as B, set_data as C, noop as D, bubble as E, PUBLIC_VERSION as P, SvelteComponent as S, create_component as a, attr as b, create_slot as c, append as d, element as e, action_destroyer as f, globals as g, get_all_dirty_from_scope as h, insert as i, get_slot_changes as j, transition_out as k, listen as l, mount_component as m, null_to_empty as n, detach as o, destroy_component as p, empty as q, run_all as r, space as s, transition_in as t, update_slot_base as u, group_outros as v, check_outros as w, onMount as x, binding_callbacks as y, init as z };
//# sourceMappingURL=index-BX3tJMsz.js.map
